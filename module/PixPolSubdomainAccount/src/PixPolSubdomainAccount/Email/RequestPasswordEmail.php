...
class RequestPasswordEmail extends AbstractEmail
{
    private $user;
    private $password;
...
A new password was requested for your account. Your new password is: ' . $this->password . '
...
The Pixel Polishers team';
    ...
    private function createHtmlPart()
    {
        $content = '<div style="margin: 0px auto; width: 500px;">
            ...
            <div style="background-color: #FFF; font-family: verdana, arial, courier; line-height: 25px; font-size: 12px; padding: 10px 0px;">
                ...
                <p style="line-height: 25px;">
                    Your new password is: <strong>' . $this->password . '</strong>
                </p>
                <p style="line-height: 25px;">
                    Cheers,
                </p>
    ...
    public function send()
    {
        ...
        $message = new Message();
        $message->setSubject('Pixel Polishers Password');
